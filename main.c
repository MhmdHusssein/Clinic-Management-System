...
*************** created by : Mohamed Hussein Mohamed Salem ***************************
*/
#include <stdio.h>
#include <stdlib.h>
#include "STD_Types.h"
...
u08 PasswordFlag = False;
u08 ExitFlag = False;
u16 ListLength = 0;

u08* AvailableSlots[6] = {"2pm to 2:30pm","2:30pm to 3pm","3pm to 3:30pm","4pm to 4:30pm","4:30pm to 5pm","Not Reserved"};
u08 ReservedSlots [6] = {0};
...
int main()
{
	u08 mode,counter = 0,adminchoice,userchoice,ans;
	u16 pass;
...
void  ReserveSlot ()
{
	...
	u08 check=0; // check if user can reserver or not 
	u08 resv=0;
